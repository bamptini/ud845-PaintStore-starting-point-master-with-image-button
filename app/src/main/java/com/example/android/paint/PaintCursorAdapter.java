...
public class PaintCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, final Context context, final Cursor cursor) {
        ...
        ImageView sampleImageView = (ImageView) view.findViewById(R.id.image_sample);
        ...
        Uri sampleImageUri = Uri.parse(sampleUriString);
        ...
        sampleImageView.setImageURI (sampleImageUri);
    }
    ...
    private void subtractStock(Context context, long id, int quantity) {
        ...
        if (quantity == 0) {
            Toast.makeText(context, "Sale failed. Quantity is already 0", Toast.LENGTH_SHORT).show();
            return;
        }
