...
public class CatalogActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void insertPaint() {
        ...
        // Get Uri for sample image
        Uri sampleUri = Uri.parse(ContentResolver.SCHEME_ANDROID_RESOURCE +
                "://" + getResources().getResourcePackageName(R.drawable.ic_sample)
                + '/' + getResources().getResourceTypeName(R.drawable.ic_sample) + '/' + getResources().getResourceEntryName(R.drawable.ic_sample));
        ...
        values.put(PaintEntry.COLUMN_SAMPLE_IMAGE, String.valueOf(sampleUri));
