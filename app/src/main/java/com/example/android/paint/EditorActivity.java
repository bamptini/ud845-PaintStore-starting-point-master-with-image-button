...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    /**
     * ImageView field to enter sample image
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSample = (ImageView) findViewById(R.id.edit_sample);
        ...
        mSample.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.i(LOG_TAG, "JAMES: OnClickListener clicked");
...
protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (data != null) {
        mSampleUri = data.getData();
        mSample.setImageURI(mSampleUri);
        mSample.invalidate();
        }
        }
        }
    ...
    private void savePaint() {
        ...
        if (mCurrentPaintUri == null &&
                ...
                TextUtils.isEmpty(quantityEntered) &&
                TextUtils.isEmpty(supplierName) &&
                TextUtils.isEmpty(supplierPhone) &&
                TextUtils.isEmpty(supplierMail) &&
                TextUtils.isEmpty(priceEntered) &&
                mSampleUri == null)
                //&& mColour == PaintEntry.PAINT_WHITE)
        {
        ...
        // By default colour is set to White and price and quantity set to zero, no checks required as these values
        // may not be known when adding a new paint.
        ...
        //Data entry required, perform checks to ensure values are added.
        if (TextUtils.isEmpty(supplierName)) {
            Toast.makeText(this, getString(R.string.message_supplier_name), Toast.LENGTH_SHORT).show();
        }else {
            values.put(PaintEntry.COLUMN_SUPPLIER_NAME, supplierName);
        }

        if (TextUtils.isEmpty(supplierPhone)) {
            Toast.makeText(this, getString(R.string.message_supplier_phone), Toast.LENGTH_SHORT).show();
        }else {
            values.put(PaintEntry.COLUMN_SUPPLIER_PHONE, supplierPhone);
        }

        if (TextUtils.isEmpty(supplierMail)) {
            Toast.makeText(this, getString(R.string.message_supplier_email), Toast.LENGTH_SHORT).show();
        }else {
            values.put(PaintEntry.COLUMN_SUPPLIER_EMAIL, supplierMail);
        }

        if (mSampleUri == null) {
            Toast.makeText(this, getString(R.string.message_image_required), Toast.LENGTH_SHORT).show();
        }else {
            values.put(PaintEntry.COLUMN_SAMPLE_IMAGE, mSampleUri.toString());
        }

        //NEEDED to ensure a price value is present
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        String[] projection = {
                ...
                PaintEntry.COLUMN_SAMPLE_IMAGE,
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int sampleColumnIndex = cursor.getColumnIndex(PaintEntry.COLUMN_SAMPLE_IMAGE);
            //NEWLY ADDED
            ...
            String sampleUriString = cursor.getString(sampleColumnIndex);
            String name = cursor.getString(nameColumnIndex);
            String phone = cursor.getString(phoneColumnIndex);
            String mail = cursor.getString(mailColumnIndex);
            mSampleUri = Uri.parse(sampleUriString);
    ...
    public void onLoaderReset(Loader<Cursor> loader) {
        ...
        mSample.setImageResource(R.drawable.ic_out_of_stock);
    }
